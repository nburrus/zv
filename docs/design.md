...
front. Sessions are recorded when images are opened; closing or deleting
images does not change the history. A separate lock file serializes the complete reload, merge, and write
