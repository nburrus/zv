...
void ImageCursorOverlay::showTooltip(const CursorOverlayInfo& d, bool showAsTooltip)
{
    ...
    auto& io = ImGui::GetIO();
    const auto& image = *d.modImagePtr->finalData()->cpuData;
    const auto& imageTexture = *d.modImagePtr->finalData()->textureData;
    ...
    
    {
        ...
        // Show the help
        {
            ...
            PixelLinearRGB lrgb = zv::convertToLinearRGB(sRgb);
